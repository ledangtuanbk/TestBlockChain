...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        for (TransactionInput i : inputs) {
            i.UTXO = TestWallet.UTXOs.get(i.transactionOutputId);
        }

        // check if transaction is valid:
        if (getInputsValue() < TestWallet.minimumTransaction) {
        ...
        for (TransactionInput i : inputs) {
            ...
            TestWallet.UTXOs.remove(i.UTXO.id);
        }
